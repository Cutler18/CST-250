    ...
    public class MineSweeperLogic
    {
        ...
        public void RevealCell(BoardModel board, int row, int column)
        {
            ...
            else
            {
                ...
                DetermineGameState(board, row, column);
            }
        ...
        /// <param name="row"></param>
        /// <param name="column"></param>
        private void DetermineGameState(BoardModel board, int row, int column)
        {
        ...
        public string DetermineReward()
        {
            ...
            // Use a switch-case to determine the rewards
        ...
        public void ApplyReward(BoardModel board, string reward, int row, int column)
        {
            ...
            */
        } // End of ApplyReward Method

        //------------------------------------------------
        // Replaced by BoardModel FloodFill
        //------------------------------------------------
        /*
        /// <summary>
        ...
        /// </summary>
        /// <param name="board"></param>
        public void RevealAll(BoardModel board)
        {
        ...
        */
        ...
        /// <returns></returns>
        public int GetBoardSize(int difficulty)
        {
            // Declare and initialize
            int size = 0;
